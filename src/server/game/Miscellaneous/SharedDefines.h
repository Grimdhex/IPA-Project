...
{
    SPELL_ATTR0_UNK0                                                = 0x00000001, /*NYI*/ // TITLE Proc Failure Burns Charge
    ...
    SPELL_ATTR0_UNK11                                               = 0x00000800, /*NYI*/ // TITLE Wearer Casts Proc Trigger DESCRIPTION Just a marker attribute to show auras that trigger another spell (either directly or with a script)
...
enum SpellAttr1 : uint32
{
    ...
    SPELL_ATTR1_UNK4                                                = 0x00000010, // TITLE No Skill Increase
    ...
    SPELL_ATTR1_IS_PICKPOCKET                                       = 0x00001000, // TITLE Pickpocket (client only) - @TODO: on master it is "Failure Breaks Stealth", need to check if it's incorrect
    ...
    SPELL_ATTR1_UNK21                                               = 0x00200000, /*NYI*/ // TITLE Threat only on Miss
    SPELL_ATTR1_FINISHING_MOVE_DURATION                             = 0x00400000, // TITLE Finishing Move - Duration
    SPELL_ATTR1_UNK23                                               = 0x00800000, /*NYI*/ // TITLE Ignore Owner's Death
    SPELL_ATTR1_IS_FISHING                                          = 0x01000000, // TITLE Fishing (client only) - @TODO: on master it is "Special Skillup", need to check if it's incorrect
    SPELL_ATTR1_UNK25                                               = 0x02000000, /*NYI*/ // TITLE Aura Stays After Combat
    SPELL_ATTR1_REQUIRE_ALL_TARGETS                                 = 0x04000000, // TITLE Require All Targets
    SPELL_ATTR1_UNK27                                               = 0x08000000, /*NYI*/ // TITLE Discount Power On Miss
    ...
    SPELL_ATTR1_ENABLE_AT_DODGE                                     = 0x40000000, // TITLE Enable at dodge - @TODO: on master it is "Dispel All Stacks", need to check if it's incorrect
    SPELL_ATTR1_UNK31                                               = 0x80000000  /*NYI*/ // TITLE Cast When Learned
};
